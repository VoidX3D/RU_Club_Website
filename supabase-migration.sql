...
-- ============================================================
-- CLUB RULES (single-row table for /rules page)
-- ============================================================
...
INSERT INTO club_rules (id, content) VALUES
  ('club-rules', E'# RU Club Motherland — Rules & Regulations\n\n## 1. Code of Conduct\n\nAll members must conduct themselves with respect, discipline, and environmental responsibility at all times.\n\n- Members must treat fellow members, teachers, and community partners with courtesy.\n- Discrimination, harassment, or bullying of any kind will not be tolerated.\n- Members must follow instructions from club coordinators and designated leaders during events.\n\n## 2. Membership\n\n### 2.1 Eligibility\n- Open to all students of Motherland Secondary School.\n- No prior experience in environmental work is required.\n- Membership is free of charge.\n\n### 2.2 Enrollment\n- Members must fill out the official registration form.\n- Registration must be approved by the club coordinator.\n- Members are required to attend the orientation session.\n\n### 2.3 Termination\n- Membership may be terminated for violation of club rules.\n- Chronic absenteeism (3+ unexcused absences from meetings/events) may result in termination.\n- Members may resign by submitting a written notice to the club coordinator.\n\n## 3. Meetings\n\n### 3.1 General Meetings\n- General meetings are held every **Friday** during the club period.\n- All members are expected to attend punctually.\n- Late arrivals (more than 10 minutes) will be marked as late.\n\n### 3.2 Special Meetings\n- Special meetings may be called by the club coordinator or president as needed.\n- Notice of special meetings must be given at least **24 hours** in advance.\n\n### 3.3 Attendance\n- Attendance is recorded at every meeting and event.\n- Members must notify the club coordinator in advance if unable to attend.\n- Three unexcused absences may result in disciplinary action.\n\n## 4. Events & Activities\n\n### 4.1 Participation\n- All members are encouraged to participate in club events and activities.\n- Members are expected to volunteer for at least **one** event per academic term.\n\n### 4.2 Preparation\n- Members must come prepared with necessary materials for workshops and events.\n- Assigned tasks must be completed before the stated deadline.\n\n### 4.3 Conduct at Events\n- Club uniform/ID must be worn during public events.\n- Members represent the school and the club — behavior must be exemplary.\n\n## 5. Projects\n\n### 5.1 Project Proposals\n- Members may propose new projects to the club leadership.\n- Proposals must be submitted in writing with a clear objective and plan.\n- The club committee will review and approve/reject proposals within two weeks.\n\n### 5.2 Project Execution\n- Approved projects must follow the timeline and budget set by the committee.\n- Regular progress reports must be submitted.\n\n## 6. Discipline\n\n### 6.1 Violations\nViolations include but are not limited to:\n- Failure to attend meetings without notice.\n- Misconduct during club activities.\n- Damaging club property or equipment.\n- Refusal to follow lawful instructions from club leaders.\n\n### 6.2 Penalties\n- **1st offense:** Verbal warning.\n- **2nd offense:** Written warning + meeting with coordinator.\n- **3rd offense:** Probation for one term.\n- **Severe offenses:** Immediate termination from the club.\n\n## 7. Dress Code\n\n- Club T-shirts or IDs must be worn during official events.\n- Members should dress appropriately for outdoor/environmental activities.\n- Closed-toe shoes are required for field activities.\n\n## 8. Resources & Materials\n\n- Club resources (tools, equipment, books) may be borrowed with permission.\n- Borrowed items must be returned within **one week**.\n- Damaged or lost items must be reported immediately.\n\n## 9. Communication\n\n- Official announcements will be made through the club notice board and class groups.\n- Members are responsible for checking announcements regularly.\n- Members may use the suggestion box for anonymous feedback.\n\n## 10. Amendments\n\n- These rules may be amended by a two-thirds majority vote of the club committee.\n- Proposed amendments must be circulated at least **one week** before voting.\n- Members will be informed of any changes via official announcement.\n\n---\n\n*Last updated: June 2026*\n\n*Enforced by the Club Committee of RU Club Motherland, Motherland Secondary School, Pokhara, Nepal.*');
