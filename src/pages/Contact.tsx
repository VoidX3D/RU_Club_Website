...
export default function Contact() {
  ...
  return (
    <>
      <SEOHead
        title="Contact"
        description="Get in touch with RU Club Motherland. Join the movement for a greener future."
        url="https://ru.motherland.edu.np/contact"
      />
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:ruclubmotherland@gmail.com" className="text-sm text-text-secondary dark:text-dark-text-secondary hover:text-brand-600 transition-colors">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-text-secondary dark:text-dark-text-secondary">
                      Pokhara Metropolitan City - 7, Kaski, Nepal
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+9779856022256" className="text-sm text-text-secondary dark:text-dark-text-secondary hover:text-brand-600 transition-colors">
                      +977 9856022256
                    </a>
                  </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2.5 rounded-xl border border-border dark:border-dark-border bg-white dark:bg-dark-surface text-text-primary dark:text-dark-text-primary placeholder:text-text-muted focus:outline-none focus:ring-2 focus:ring-brand-500/50 focus:border-brand-500 transition-all"
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={handleChange}
                      className="w-full px-4 py-2.5 rounded-xl border border-border dark:border-dark-border bg-white dark:bg-dark-surface text-text-primary dark:text-dark-text-primary placeholder:text-text-muted focus:outline-none focus:ring-2 focus:ring-brand-500/50 focus:border-brand-500 transition-all resize-none"
